 ...
 class HtPanel extends JPanel implements MouseListener, MouseMotionListener
{
	...
	//	g.clearRect( 0 , 0 , 700 , 700 ) ;			//Ö÷Ãæ°æ
		
//``````````````````````````````````````````````````````````````````````````
		if (b)
		{
			g.setColor(new Color( 80 , 180 , 80 )) ;			//¹êÎ²°Í
...
//``````````````````````````````````````````````````````````````````````````		
		if (b)
		{
			g.setColor(new Color(80,180,80)) ;		//¹êÍ·
			g.fillOval( 120+x , 80+y , 60 , 100 ) ;
			g.setColor(Color.WHITE) ;
			g.fillOval( 130+x ,90+y , 10 ,10 ) ;		//×óÑÛ	
			g.fillOval( 160+x ,90+y , 10 ,10 ) ;		//ÓÒÑÛ
			g.setColor(Color.BLACK) ;
			g.fillOval( 130+x ,90+y , 8 ,8 ) ;			//×óÑÛÖé
			g.fillOval( 160+x ,90+y , 8 ,8 ) ;			//ÓÒÑÛÖé
		}
		else
		{
			g.setColor(new Color(80,180,80)) ;		//¹êÍ·
			g.fillOval( 120+x , 80+y , 60 , 100 ) ;
			g.setColor(new Color(200,0,0)) ;		//¹ê×ì
			g.fillOval( 130+x , 100+y , 40 ,50 ) ;
			g.setColor(new Color(80,180,80)) ;
			g.fillOval( 130+x , 80+y , 40 ,50 ) ;
			g.setColor(Color.BLACK) ;
			g.drawLine( 143+x ,83+y , 140+x , 90+y ) ;		//±Ç×Ó
...
//``````````````````````````````````````````````````````````````````````````	
		...
		{
			g.setColor(new Color(80,180,80)) ;
			g.fillOval( 50+x ,140+y ,50 , 70 ) ;		//×ó×¦

			g.fillOval( 200+x ,140+y ,50 , 70 ) ;		//ÓÒ×¦

			g.fillOval( 50+x ,280+y ,50 , 70 ) ;		//×óºó×¦

			g.fillOval( 200+x ,280+y ,50 , 70 ) ;		//ÓÒºó×¦
		}
		else
		{	
			g.setColor(new Color(80,180,80)) ;		//×ó×¦
			g.fillOval( 50+x ,140+y ,50 , 70 ) ;	
			g.setColor(new Color(250,100,150)) ;	//×óÖ¸Í·
			...
			g.setColor(new Color(80,180,80)) ;		//ÓÒ×¦
			g.fillOval( 200+x ,140+y ,50 , 70 ) ;
			g.setColor(new Color(250,100,150)) ;	//ÓÒÖ¸Í·
			...
			g.setColor(new Color(80,180,80)) ;		//×óºó×¦
			g.fillOval( 50+x ,280+y ,50 , 70 ) ;
			g.setColor(new Color(250,100,150)) ;	//×óºóÖ¸Í·		
			...
			g.setColor(new Color(80,180,80)) ;		//ÓÒºó×¦
			g.fillOval( 200+x ,280+y ,50 , 70 ) ;
			g.setColor(new Color(250,100,150)) ;	//ÓÒºóÖ¸Í·		
...
//```````````````````````````````````````````````````````````````````````````
		if (b)
		{
			g.setColor(new Color(50 ,160 , 50)) ;	//¹êÉí´óÈ¦
			g.fillOval( 60+x , 150+y , 180 ,200 ) ;		
			g.setColor(new Color(50,200,50)) ;
			g.fillOval( 70+x , 160+y , 160 ,180 ) ;		//Ğ¡È¦

			g.setColor(new Color(0,0,0)) ;
			g.drawLine( 130+x , 210+y , 170+x , 210+y ) ;	//ÖĞ¼äµÄ»¨ÎÆ
			...
			g.drawLine( 100+x , 180+y , 130+x , 210+y ) ;	//À©É¢³öÀ´µÄ»¨ÎÆ
		...
		{
			g.setColor(new Color(80,180,80)) ;
			g.fillOval( 60+x , 150+y , 180 ,200 ) ;		//¹êÉí´óÈ¦
			g.setColor(new Color(255,230,240)) ;
			g.fillOval( 70+x , 160+y , 160 ,180 ) ;		//Ğ¡È¦
			
			g.setColor(new Color(0,0,0)) ;			//¶Ç¶ÇÉÏµÄ»¨ÎÆ
